...
#define RECEIVE_DATA_SIZE 25         //The length of the data sent by the lower computer //下位机发送过来的数据的长度
...
private:
	...
	rclcpp::Publisher<std_msgs::msg::UInt8>::SharedPtr userkey_publisher;  //user key
	...
	float Power_voltage;
  unsigned char user_key = 0;   //user key
    size_t count_;
};
