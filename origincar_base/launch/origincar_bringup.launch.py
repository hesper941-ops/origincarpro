...
def generate_launch_description():
    ...
    map_to_odom = launch_ros.actions.Node(
            ...
            name='map_to_odom',
            arguments=['0', '0', '0','0', '0','0','map','odom_combined'],  #0.41;0.14
    )
    ...
    base_to_link = launch_ros.actions.Node(
            ...
            executable='static_transform_publisher', 
            name='base_to_link',
            arguments=['0', '0', '0','0', '0','0','base_footprint','base_link'],  #0.41;0.14
    )
    ...
    camera_to_depth = launch_ros.actions.Node(
            package='tf2_ros', 
            executable='static_transform_publisher', 
            name='link_to_depth',
            arguments=['0', '0', '0', '-1.57', '0','-1.57','depth_camera_link_1','depth_camera_link'],   #'-1.57', '0','-1.57'
    )
