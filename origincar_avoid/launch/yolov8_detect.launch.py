...
def generate_launch_description():
    ...
    yolo_avoid_finished_topic = LaunchConfiguration('yolo_avoid_finished_topic')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            default_value=TextSubstitution(text='/yolo_avoid_finished'),
            description='YOLO obstacle avoidance finished topic'
        ),
        ...
        Node(
            ...
            parameters=[
                ...
                {'yolo_avoid_finished_topic': yolo_avoid_finished_topic},
                ...
                # 连续多少帧不接管，才认为避障完成
                {'avoid_finish_confirm_frames': 6},

                # 避障完成事件冷却时间，防止重复触发
                {'avoid_finished_cooldown_sec': 1.0},
